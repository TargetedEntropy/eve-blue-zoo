...
class MarketHashes(Base):
    __tablename__ = "market_history_hashes"
...
class MarketUpdates(Base):
    __tablename__ = "market_history_updates"
...
def get_all_regions():
    results = (
        ...
        .order_by(MapRegion.regionID.asc())
        .all()
    )
    return results
...
def save_market_data(response_data):
    ...
    # Create a new MarketHistory instance
    new_order = MarketHistory(
