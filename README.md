...
This is a basic template to implement Eve Online SSO and basic ESI calls into the [Flask Dashboard Black](https://appseed.us/product/black-dashboard/flask/) template.
